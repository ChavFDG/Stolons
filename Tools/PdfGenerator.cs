...
namespace PhantomJs.NetCore {
    ...
    public class PdfGenerator {
        ...
        private string ExecutePhantomJs(string phantomJsExeToUse,string inputFileName, string outputFilePath) {
            ...
            startInfo.Arguments = String.Format("rasterize.js \"{0}\" {1} \"A4\"", inputFileName, outputFilePath);
        ...
        private string WriteHtmlToTempFile(string html) {
            ...
            File.WriteAllText(absolutePath, html, Encoding.UTF8);
         ...
         */
        public string GeneratePdf(string html, string outputFile) {
            ...
            string pdfFileName = "";
            try {
                pdfFileName = ExecutePhantomJs(phantomExeToUse, htmlFileName, outputFile);
            } finally {
